...
function autoReply() {
  ...
  let message = `
		<div class="chatbox-message-item received">
			<span style="text-decoration: overline;" class="chatbox-message-item-text">
				Hallo, selamat datang di website kami :), <br>
        Silahkan menikmati fitur layanan kami diantaranya yaitu : <br>
        <br>1. Ibu dan anak
        <br>2. Stunting
        <br>3. Narkoba
        <br>4. Olahraga
        ...
        <br>6. HIV/AIDS
        <br><br>
        semua itu dapat anda akses melalui fitur kami di bawah, terimakasih.
			</span>
			<span class="chatbox-message-item-time">${addZero(today.getHours())}:${addZero(
    today.getMinutes()
  )}</span>
